...
export default function UpdateProductForm({product}: {product: IProduct}) {
    ...
    const [ state, formAction, isPending ] = useActionState(editProductWithId, initiaState);
        ...
        <div className="bg-white rounded-lg shadow-lg p-8 w-full max-w-md">
            ...
            <form action={formAction} className="space-y-4">
                <div>
                    ...
                    <input name="name" defaultValue={product.name} type="text" placeholder="Product Name" className="w-full text-black border border-gray-300 rounded-md p-3 focus:outline-none focus:ring-2 focus:ring-blue-500" />
                    {
                ...
                <div>
                    ...
                    <input name="price" type="number" defaultValue={product.price} placeholder="Product Price" className="w-full text-black border border-gray-300 rounded-md p-3 focus:outline-none focus:ring-2 focus:ring-blue-500" />
                    {
                ...
                <div>
                    ...
                    <textarea name="description" defaultValue={product.description ?? ""} placeholder="Product Description" className="w-full text-black border border-gray-300 rounded-md p-3 h-24 resize-none focus:outline-none focus:ring-2 focus:ring-blue-500" />
                    {
